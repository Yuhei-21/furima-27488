...
ActiveRecord::Schema.define(version: 2020_08_10_053329) do
  ...
  create_table "cards", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC", force: :cascade do |t|
